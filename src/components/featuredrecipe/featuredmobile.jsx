import { FeaturedRecipeMobile } from "../api/feacturedrecipeapi"

const FeaturedMobile = () => {
    return (
        <>
            {FeaturedRecipeMobile.map((item, index) => {
                return (
                        ...
                        <div className="p-3">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    <span className="font-[600] md:text-[0.9rem]">{item.name}</span>
                                </div>
                                <div>
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    <span className="text-[#058B42] mr-1 md:text-[0.9rem]">{item.description}</span>
