import { FeaturedRecipesDesktop } from "../api/feacturedrecipeapi"

const FeaturedDesktop = () => {
    return (
        <>
            {FeaturedRecipesDesktop.map((item, index) => {
                return (
                    <div className="hidden md:flex flex-col rounded shadow-md" key={index}>
                        ...
                        <div className="p-3">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    ...
                                    {index !== 1 && index !== 2 && index !== 5 && (
                                        <img className="w-[20px] h-[20px]" src={item.icon1} alt="" />
                                    )}
                                    <span className="mr-1 font-[600] md:text-[0.8rem]">{item.name2 }</span>
                                    {index !== 1 && index !== 2 && index !==3 && index !==4 && index !== 5 && (
                                        <img className="w-[20px] h-[20px]" src={item.icon3} alt="" />
                                    )}
                                    {index !== 0 && index !== 1 && index !== 3 && index !== 4 && index !== 5 && (
                                        <img className="pb-1 w-[20px] h-[20px]" src={item.icon2} alt="" />
                                    )}
                                </div>
                                <div>
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    ...
                                    <span className="text-[#6E6E6E] md:text-[0.8rem]">{item.text}</span>
                                </div>
                                <div className="flex items-center mt-2">
                                    <span className="text-[0.8rem] mx-2">{item.rating}</span>
