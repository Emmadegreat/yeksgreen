            ...
            <div className="bg-[#04471C] h-[80px] pt-2 text-[#fff] flex justify-start items-center md:px-10 px-6">
                ...
                <div className="flex items-center text-start">
                    <svg width="30" height="30" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M34 42.5V38.5C34 36.3783 33.1571 34.3434 31.6569 32.8431C30.1566 31.3429 28.1217 30.5 26 30.5H10C7.87827 30.5 5.84344 31.3429 4.34315 32.8431C2.84285 34.3434 2 36.3783 2 38.5V42.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M18 22.5C22.4183 22.5 26 18.9183 26 14.5C26 10.0817 22.4183 6.5 18 6.5C13.5817 6.5 10 10.0817 10 14.5C10 18.9183 13.5817 22.5 18 22.5Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M46 42.5V38.5C45.9987 36.7275 45.4087 35.0055 44.3227 33.6046C43.2368 32.2037 41.7163 31.2031 40 30.76" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M32 6.76C33.7208 7.2006 35.2461 8.2014 36.3353 9.60462C37.4245 11.0078 38.0157 12.7337 38.0157 14.51C38.0157 16.2863 37.4245 18.0122 36.3353 19.4154C35.2461 20.8186 33.7208 21.8194 32 22.26" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
